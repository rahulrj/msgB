...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
        ...
        <title>Facebook Connect Demo | 25 labs</title>    
...
?>
<p> <?php echo $logoutUrl;?></p>

<div id="bar">
	<div class="top-area">
		<div class="logo" ><a href="login.php" ><img src="images1/facebook-logo.jpg" /></a></div>
		<div class="side-box" >
			<div class="link"><a href="http://25labs.com/tutorial-integrate-facebook-connect-to-your-website-using-php-sdk-v-3-x-x-which-uses-graph-api/" " target="_blank" ><h5>Click here to read the tutorial on 25labs.com</h5></a></div>			
			<div class="logout" >
				<?php				
				if ($user) echo '<a href="' . $logoutUrl . '"><h5>Logout</h5></a>';
...
<?php if(!$user) { ?>
<div class="login-box">
<div id="f-connect-button"><a href="<?=$loginUrl?>"><img src="images1/f-connect.png" alt="Connect to your Facebook Account"/></a><div>
